...
# ====== CHANNELS DATABASE ======
# 1. Yahan Poster save honge
STORAGE_CHANNEL_ID = int(os.getenv("STORAGE_CHANNEL_ID", -1003629012882))

# 2. Yahan Episodes/Videos save honge (APNE NAYE CHANNEL KI ID YAHAN DAALEIN 👇)
EPISODE_CHANNEL_ID = int(os.getenv("EPISODE_CHANNEL_ID", -1000000000000)) # <--- Ise change karein
# ===============================
